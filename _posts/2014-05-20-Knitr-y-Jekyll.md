...
[Knitr](http://yihui.name/knitr/) es el paquete de [R](http://www.r-project.org/) que nos permite incorporar a nuestra publicación o **post** los resultados obtenidos en `RStudio`. Para ello es necesario incluir en el archivo *R Markdown* los trozos de código R que necesitemos.  Posteriormente **knitr** lo compilará y generará como resultado una página *html* lista para ver en cualquier navegador.
